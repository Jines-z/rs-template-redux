/* ========================================================
    ...
    ** 配置文件 **
    ...
    2、theme    ：主题配置
    3、global   ：全局变量，使用时前后加“__”，字母变大写，例如 __ENV__，可进行自定义扩展
...
module.exports = {
    ...
    publicPath : NODE_ENV === 'development' ? './' : 'https://jines-z.github.io/rs-redux/',
    open       : true,
    esLint     : true,
    relative   : false,
    vendor     : ['react', 'react-dom', 'react-router-dom', 'react-loadable', 'redux', 'react-redux', 'crypto-js', 'js-cookie', 'flyio'],
    config     : {}
}
